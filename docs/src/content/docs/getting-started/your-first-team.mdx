...
description: Walk through the executive template — the default 3-bot team that ships with disclaw-team.
---
...
The executive template is a 3-bot team:

- **Orchestrator** — the entry point. Listens for tasks in the configured channel, delegates work to other bots via Discord @mentions, and synthesizes results.
- **Researcher** — handles web search, reading, and analysis. Spawns subagents for deep research tasks.
- **Writer** — produces documents, summaries, and reports based on research results.
